...
@section('judul')
    <h1 class="text-dark">Detail Anggota</h1>
@endsection
    ...
    <div class="card">
        ...
        <div class="row d-flex" style="gap:3rem">
            ...
            <div class="col-4">
                ...
                <div class="form-group mb-3">
                    <label for="nis" class="text-lg text-primary font-weight-bold">NIS</label>
                    <h4>{{ $profile->nis }}</h4>
                </div>
        ...
        <div class="edit d-flex justify-content-end my-4 mx-4">
            <a href="/anggota" class="btn btn-outline-danger px-5">Kembali</a>
        </div>
    </div>
    <h2 class="text-dark my-4">Daftar Riwayat Pinjaman Anggota</h2>
